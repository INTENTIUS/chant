...
[![chant](https://github.com/intentius/chant/actions/workflows/chant.yml/badge.svg)](https://github.com/intentius/chant/actions/workflows/chant.yml)
[![e2e (nightly)](https://github.com/intentius/chant/actions/workflows/warden-github-e2e.yml/badge.svg)](https://github.com/intentius/chant/actions/workflows/warden-github-e2e.yml)
...
The action is still referenced as `intentius/github-warden@v1` — that repo
now hosts only the action shim; the source of truth is `wardens/github` in
[intentius/chant](https://github.com/intentius/chant) (#788).
