...
// The container image the service runs — the api component wires the just-built
// image in via `image: "@Publish.uri"` at deploy time; this default keeps the
// template synthesizable and runnable on its own.
