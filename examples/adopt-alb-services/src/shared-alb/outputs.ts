...
// ALB / cluster outputs — service stacks reference these (the names the service
// components pass to stackOutput("shared-alb", ...)).
...
// VPC outputs — service task networking.
...
// ECR repository outputs — service push targets.
