...
You can define project-specific lint rules using the declarative `rule({...})` format. Custom rules are TypeScript files that are parsed as data — no code is executed.

## Setup

Add your rule files to the `plugins` array in your chant config:
