...
**ALB HTTP listener does not redirect to HTTPS** — merge-worthy · guidance

Add a redirect DefaultAction (Protocol: HTTPS) to the HTTP listener.
...
Restrict the CIDR; only ALB:443 is exempt from this rule.
