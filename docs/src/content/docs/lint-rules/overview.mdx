...
| **Correctness** | COR003, COR004, COR007, COR008, COR017, COR021, COR022–COR026, OPS012–OPS014 | Single file / post-synth | Structural errors |
...
- [Correctness Rules](/chant/lint-rules/correctness/) — COR003, COR004, COR007, COR008, COR021, COR022–COR024 (effect-receipt guards), COR025 (stringified reference), COR026 (stale knowledge binding), OPS012–OPS014 (Op model: activity contracts, step-output references, ConvergeOp rule-table refusals)
