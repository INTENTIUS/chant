...
|---------|---------|-----------|-----------|
| AWS CloudFormation | `@intentius/chant-lexicon-aws` | 1500+ | [Reference](/lexicons/aws/) |
| GitLab CI/CD | `@intentius/chant-lexicon-gitlab` | 3 resources, 13 properties | [Reference](/lexicons/gitlab/) |
...
- [Managing Lexicons](/guide/managing-lexicons/) — add, remove, and update lexicons
- [Sync Mechanism](/lexicons/sync/) — how type definitions stay in sync
- [Lexicon Authoring](/lexicon-authoring/overview/) — create and publish your own lexicons
