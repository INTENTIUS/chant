...
Lint rules specific to the target ecosystem. These integrate with `npx chant lint` to catch provider-specific mistakes like invalid resource configurations or naming convention violations.
