...
- **K8s** — the most mature lexicon: 29 post-synth checks, 9 skills, 33 required names, full docs site
- **Azure** — comprehensive ARM template lexicon with 20 post-synth checks, 4 skills, and 14 doc pages
