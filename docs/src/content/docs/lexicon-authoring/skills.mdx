...
1. Import types from the lexicon barrel (`_`)
2. Use intrinsic functions for dynamic values
3. Reference other resources via the barrel symbol (`$`)
```
...
- **Install**: `npx chant init` copies skills to `.chant/skills/`
- **Update**: `npx chant update` refreshes skills when a lexicon is updated
