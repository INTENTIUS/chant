...
`SkillFileSpec` is a `SkillDefinition` field minus `content`. Sixteen of the
eighteen lexicons wire skills this way. `lexicons/fly/src/plugin.ts:79` is a
...
Seventeen of the eighteen lexicons ship skills. Only k3d ships none
...
| OTel | `chant-otel`, `chant-otel-custom-components`, `chant-otel-platforms` | 3 |
