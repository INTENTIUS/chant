...
The Temporal lexicon's `chant-temporal-ops.md` is the reference example — it teaches agents how to signal gate steps, diagnose stuck activities, and cancel runs via `chant run` and the Temporal CLI.
...
| Fountain | `chant-fountain`, `chant-fountain-secrets`, `chant-fountain-locked-sandboxes` | 3 |
...
| Temporal | `chant-temporal`, `chant-temporal-ops` | 2 |
