...
`compareProvenance(a, b)` classifies a pair before anything subtracts them:

| Verdict | When |
|---|---|
| `comparable` | same engine, version, tolerance and basis. The difference is a difference in the estate |
| `mixed-basis` | same engine and version, one figure modeled and the other validated |
