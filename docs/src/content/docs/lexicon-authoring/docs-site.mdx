...
Each lexicon includes a documentation site built with [Astro Starlight](https://starlight.astro.build/), living in `lexicons/<name>/docs/`. All eighteen lexicons have one.
