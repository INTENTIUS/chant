...
- [AWS CloudFormation lexicon](/lexicons/aws/) — resource reference, composites, examples
- [GitLab CI/CD lexicon](/lexicons/gitlab/) — job types, composites, pipeline examples
