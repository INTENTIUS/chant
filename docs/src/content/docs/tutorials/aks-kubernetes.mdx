...
AKS control plane free (free tier), Application Gateway ~$20/mo, 3× Standard_B2s nodes ~$75/mo. **Total ~$95/mo** (eastus list price, checked 2026-08 against chant 0.46.0; Azure list prices change and vary by region — re-price before relying on this number). Teardown after testing.
