...
<Aside type="caution">
GKE cluster (3× n2-standard-4) + Filestore ENTERPRISE (1Ti) + NAT gateway ≈ $300+/mo while running (us-central1 list price, checked 2026-08 against chant 0.46.0; GCP list prices change and vary by region — re-price before relying on this number). The GPU node pool scales to zero. Tear down after testing.
</Aside>
