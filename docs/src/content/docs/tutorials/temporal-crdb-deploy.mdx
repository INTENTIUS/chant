...
<Aside type="note" title="Raw Temporal approach">
This tutorial covers the **raw Temporal path**: you write your own workflow TypeScript with signals, heartbeats, queries, and updates. If you want chant to generate that code from a declarative `*.op.ts` file, see the [Ops guide](/chant/guide/ops/) instead. Not sure which fits your situation? See [Choosing Your Deployment Model](/chant/concepts/deployment-paths/).
</Aside>
