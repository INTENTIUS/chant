...
GKE control plane free (one zonal cluster), Cloud NAT ~$32/mo, 3× e2-medium nodes ~$75/mo. **Total ~$107/mo** (us-central1 list price, checked 2026-08 against chant 0.46.0; GCP list prices change and vary by region — re-price before relying on this number). Teardown after testing.
