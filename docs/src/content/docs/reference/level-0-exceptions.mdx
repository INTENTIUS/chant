...
Nothing on this list has shipped a warning yet. An entry gets its warning release when that release goes out, and its change can land from the release after.
...
| An additive `version` field on `chant graph --format ir` output | [#2529](https://github.com/INTENTIUS/chant/issues/2529) ([#2524](https://github.com/INTENTIUS/chant/issues/2524) D8) | not yet shipped |
