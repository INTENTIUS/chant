...
| the read contract: versioned JSON of `ls`, `graph`, `check`, `records`, `status`, `graph --intent`, `graph --composites`, `points`, closed reason codes | identity, sessions, who is looking | agent prompts and context bundles |
...
| workspace command | `commandRegistry` in `cli/main.ts`, and each sub-verb its help names | 25 | 0 | 0 |
...
| reason code | `REASONS` in `reason-codes.ts`, less the finding codes | 119 | 0 | 0 |
| finding code | the finding codes of `intent.schema.json` | 17 | 0 | 0 |
| WSP check | `WORKSPACE_CHECKS` in `checks.ts` and `checks/*.ts` | 40 | 0 | 0 |
...
| boundary cell | the read contract: versioned JSON of `ls`, `graph`, `check`, `records`, `status`, `graph --intent`, `graph --composites`, `points`, closed reason codes | chant | ls.schema.json, graph.schema.json, check.schema.json, records.schema.json, status.schema.json, intent.schema.json, composites.schema.json, points.schema.json | The only way a reader sees a workspace: one JSON Schema per document, a contract version and a chant floor. |
...
| reason code | `declaration-missing` | chant | check.schema.json, composites.schema.json, graph.schema.json, intent.schema.json, ls.schema.json, points.schema.json, status.schema.json | No chant.workspace.json or .jsonc between the directory and the git root. |
| reason code | `declaration-ambiguous` | chant | check.schema.json, composites.schema.json, graph.schema.json, intent.schema.json, ls.schema.json, points.schema.json, status.schema.json | Both chant.workspace.json and chant.workspace.jsonc exist. |
| reason code | `declaration-unparseable` | chant | check.schema.json, composites.schema.json, graph.schema.json, intent.schema.json, ls.schema.json, points.schema.json, status.schema.json | The declaration is not valid JSON, or not valid JSONC for .jsonc. |
| reason code | `declaration-invalid` | chant | check.schema.json, composites.schema.json, graph.schema.json, intent.schema.json, ls.schema.json, points.schema.json, status.schema.json | The declaration does not match its schema, repeats a name, or --member names no entry. |
| reason code | `placement-invalid` | chant | check.schema.json, composites.schema.json, graph.schema.json, intent.schema.json, ls.schema.json, points.schema.json, status.schema.json | A member or group match breaks a placement rule. |
| reason code | `reader-too-old` | chant | check.schema.json, composites.schema.json, graph.schema.json, intent.schema.json, ls.schema.json, points.schema.json, status.schema.json | The declaration's minReader is newer than the chant reading it. |
| reason code | `root-chant-required` | chant | check.schema.json, composites.schema.json, graph.schema.json, intent.schema.json, ls.schema.json, points.schema.json, status.schema.json | The declaration pins a chant version other than the reader's, and that chant is not installed at the workspace root. |
| reason code | `not-a-git-repository` | chant | check.schema.json, composites.schema.json, graph.schema.json, intent.schema.json, ls.schema.json, points.schema.json, records-since.schema.json, records.schema.json, status.schema.json, work-lease.schema.json | --at, or a ledger read, needs a git repository and there is none. |
| reason code | `revision-unknown` | chant | check.schema.json, composites.schema.json, graph.schema.json, intent.schema.json, ls.schema.json, points.schema.json, records-since.schema.json, records.schema.json | --at names no commit. |
...
| reason code | `record-schema-invalid` | chant | intent.schema.json, points-write.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | The record's front matter, or its JSON object, does not match the kind's schema. |
| reason code | `record-id-duplicate` | chant | intent.schema.json, points-write.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | Another record earlier in path order has the same id. |
| reason code | `record-supersedes-unknown` | chant | intent.schema.json, points-write.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | A supersedes link names an id no record has. |
| reason code | `record-supersedes-conflict` | chant | intent.schema.json, points-write.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | A second closed record supersedes a record another one already superseded. |
| reason code | `session-seal-mismatch` | chant | points-write.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | A closed session's seal is not the digest of its text: the session changed after it closed. |
| reason code | `session-verdict-unknown-record` | chant | points-write.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | A session's verdict names a record that none of the session kind's subject records has. |
...
| reason code | `kind-unreadable` | chant | intent.schema.json, ls.schema.json, points-write.schema.json, points.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json, work-lease.schema.json | The record kind file is missing or could not be imported. |
| reason code | `kind-invalid` | chant | intent.schema.json, ls.schema.json, points-write.schema.json, points.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json | The record kind file exports no recordKind, or its shape is wrong. |
| reason code | `schema-unreadable` | chant | intent.schema.json, ls.schema.json, points-write.schema.json, points.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json | The schema file the record kind names is missing or is not JSON. |
| reason code | `schema-id-mismatch` | chant | intent.schema.json, ls.schema.json, points-write.schema.json, points.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json | The schema's $id differs from the id the record kind names. |
| reason code | `schema-invalid` | chant | intent.schema.json, points-write.schema.json, points.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json | The record schema itself does not compile. |
| reason code | `location-missing` | chant | intent.schema.json, points-write.schema.json, points.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json | The records directory does not exist, in the tree or at the revision. |
| reason code | `write-usage-invalid` | chant | points-write.schema.json, records-amend.schema.json, records-close.schema.json, records-new.schema.json, records-review.schema.json, work-lease.schema.json | The command line lacks a value the write needs, or gives one it does not take. |
| reason code | `write-input-invalid` | chant | points-write.schema.json, records-amend.schema.json, records-new.schema.json | The fields given with --from or --set can't be read, are not JSON, or are not a JSON object. |
| reason code | `record-not-found` | chant | points-write.schema.json, records-amend.schema.json, records-close.schema.json, records-review.schema.json | No record of the kind has the id given. |
...
| reason code | `record-closed` | chant | points-write.schema.json, records-amend.schema.json, records-close.schema.json, records-review.schema.json | The record is in a closed state, so nothing in it changes; a new record supersedes it instead. |
...
| reason code | `quorum-not-met` | chant | points-write.schema.json | Too few of the people who answered count toward the point's quorum: distinct, not holding the agent role, and holding one of its roles when it names any. |
