...
| reason code | `REASONS` in `reason-codes.ts`, less the finding codes | 66 | 0 | 0 |
...
| reason code | `kind-unreadable` | chant | intent.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | The record kind file is missing or could not be imported. |
| reason code | `kind-invalid` | chant | intent.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | The record kind file exports no recordKind, or its shape is wrong. |
| reason code | `schema-unreadable` | chant | intent.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | The schema file the record kind names is missing or is not JSON. |
| reason code | `schema-id-mismatch` | chant | intent.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | The schema's $id differs from the id the record kind names. |
| reason code | `schema-invalid` | chant | intent.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | The record schema itself does not compile. |
| reason code | `location-missing` | chant | intent.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | The records directory does not exist, in the tree or at the revision. |
