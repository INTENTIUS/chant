...
| reason code | `REASONS` in `reason-codes.ts`, less the finding codes | 55 | 0 | 0 |
...
| reason code | `review-undigested` | chant | records.schema.json | A verdict names no digest of the text it judged. It still counts, and an amendment does not stop it counting. |
