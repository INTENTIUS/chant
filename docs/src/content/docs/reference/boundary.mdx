...
| WSP check | `WORKSPACE_CHECKS` in `checks.ts` and `checks/*.ts` | 35 | 0 | 0 |
...
| reason code | `record-unparseable` | chant | intent.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | No front matter, a YAML error or a value outside the JSON subset of YAML, or for a JSON kind a file that is not one object or repeats a member name. |
| reason code | `record-schema-invalid` | chant | intent.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records.schema.json | The record's front matter, or its JSON object, does not match the kind's schema. |
...
| reason code | `kind-unreadable` | chant | intent.schema.json, ls.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json | The record kind file is missing or could not be imported. |
| reason code | `kind-invalid` | chant | intent.schema.json, ls.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json | The record kind file exports no recordKind, or its shape is wrong. |
| reason code | `schema-unreadable` | chant | intent.schema.json, ls.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json | The schema file the record kind names is missing or is not JSON. |
| reason code | `schema-id-mismatch` | chant | intent.schema.json, ls.schema.json, records-amend.schema.json, records-new.schema.json, records-review.schema.json, records-since.schema.json, records.schema.json | The schema's $id differs from the id the record kind names. |
