...
| `quorum-not-met` | error, `points answer` | Too few of the people named count toward the point's quorum: distinct, not holding the agent role, and holding one of its roles when it names any. |
