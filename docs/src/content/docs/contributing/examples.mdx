...
| `examples/fan-out-estate` | Reference deployment (one network stack, two clusters and twelve apps as fifteen stacks, deployed by a fan-out whose order is derived from the source) |
