...
<Diagram name="multi-stack-projects" alt="Multi-stack project layout: parent source referencing child project via stackOutput, producing separate output files" caption="Multi-stack source layout and output files" />
