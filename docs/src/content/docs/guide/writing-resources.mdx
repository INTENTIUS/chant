...
Import the barrel and instantiate a typed resource constructor:

```typescript
import * as _ from "./_";

export const myResource = new _.ResourceType({
  name: "my-resource",
  property: "value",
});
```
...
- [Cross-File References](/guide/cross-file-references/) — reference resources defined in other files
- [Composite Resources](/guide/composite-resources/) — group related resources into reusable units
- [Presets](/guide/presets/) — share default property values across resources
