...
See the [Lexicon Authoring Guide](/lexicons/authoring/) for the full walkthrough.
...
Add lexicon-specific or project-specific lint rules. See [Custom Rules](/lint-rules/custom-rules/).
