...
| [#637](https://github.com/INTENTIUS/chant/issues/637), [#638](https://github.com/INTENTIUS/chant/pull/638) | Apply `chant.config` defaults on the Temporal codegen path |
