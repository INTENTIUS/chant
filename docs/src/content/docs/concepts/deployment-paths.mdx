...
chant covers the synthesis step — TypeScript in, validated artifacts out — and offers optional layers beyond that: Ops, the lifecycle dial, and the component release model. Knowing which layer fits your situation avoids unnecessary setup.
