...
[Explore the CDK capture interactively](https://spicypath.intentius.workers.dev/#eyJ2dCI6ImZsYW1lIiwibW9kZSI6ImNoYXJ0IiwibWsiOltbMTA1NzUxODczNDU5LCJ5b3VyIGNvZGUgc3RhcnRzIGhlcmUiXV0sInNyYyI6InNhbXBsZXMvbGVmdG5lc3MtY2RrLXN5bnRoLmNwdXByb2ZpbGUiLCJzcmNUeXBlIjoic2FtcGxlIn0=) — the link restores the timeline, the highlight, and the marker.
