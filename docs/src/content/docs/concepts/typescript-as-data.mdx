...
As of this measurement, **94 of 108** example projects in the corpus fold completely — every file in them reduces to a value with zero module execution. The remaining **14** have at least one file that falls back to running.
