...
The `$` symbol table provides directory-scoped access to sibling resource exports. See [Barrel Files & the $ Symbol](/concepts/barrels/) for the full explanation.
...
For the full EVL rule reference with configuration options, see [Evaluability Rules](/lint-rules/evaluability/).
