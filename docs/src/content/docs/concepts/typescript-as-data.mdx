...
As of this measurement, **53 of 99** example projects in the corpus fold completely — every file in them reduces to a value with zero module execution. The remaining **46** have at least one file that falls back to running.
