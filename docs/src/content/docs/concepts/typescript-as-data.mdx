...
As of this measurement, **96 of 108** example projects in the corpus fold completely — every file in them reduces to a value with zero module execution. The remaining **12** have at least one file that falls back to running.
