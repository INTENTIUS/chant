...
As of this measurement, **97 of 111** example projects in the corpus fold completely — every file in them reduces to a value with zero module execution. The remaining **14** have at least one file that falls back to running.
