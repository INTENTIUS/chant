...
As of this measurement, **75 of 105** example projects in the corpus fold completely — every file in them reduces to a value with zero module execution. The remaining **30** have at least one file that falls back to running.
