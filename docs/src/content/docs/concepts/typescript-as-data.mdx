...
As of this measurement, **53 of 98** example projects in the corpus fold completely — every file in them reduces to a value with zero module execution. The remaining **45** have at least one file that falls back to running.
