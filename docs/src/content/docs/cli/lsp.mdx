...
- [Agent Integration](/chant/guide/agent-integration/) — MCP setup for AI agents
- [`chant serve mcp`](/chant/cli/mcp/) — MCP server for AI agent integration
- [`chant lint`](/chant/cli/lint/) — CLI linting (same rules as LSP diagnostics)
