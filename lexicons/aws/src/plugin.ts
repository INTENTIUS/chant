...
aws cloudformation wait stack-update-complete --stack-name my-app-prod`,
  ...
  async describeResources(options: {
    ...
    if (undescribed.length > 0) {
      ...
      return observation({ ...described, ...identity.resources }, holes, identity.queried, stackExports);
    }
    ...
    return observation({ ...withProperties, ...identity.resources }, undefined, identity.queried, stackExports);
  },
