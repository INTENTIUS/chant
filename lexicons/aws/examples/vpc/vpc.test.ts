...
describe("vpc example", () => {
  ...
  test("build produces valid CloudFormation", async () => {
    ...
    // VpcDefault expands to 17 resources
    expect(Object.keys(parsed.Resources)).toHaveLength(17);
    expect(parsed.Resources.networkVpc).toBeDefined();
    expect(parsed.Resources.networkIgw).toBeDefined();
