...
{/* GENERATED-BY-CHANT-DOCS by `npm run docs -w @intentius/chant-lexicon-cpln` — DO NOT EDIT.
    Edit lexicons/cpln/docs/pages/workload-types.mdx instead; changes here are overwritten. */}
