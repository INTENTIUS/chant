...
{/* GENERATED-BY-CHANT-DOCS by `npm run docs -w @intentius/chant-lexicon-temporal` — DO NOT EDIT.
    Edit lexicons/temporal/docs/pages/resources.mdx instead; changes here are overwritten. */}


import Diagram from '../../components/Diagram.astro';

<Diagram name="temporal-runtime" alt="chant Temporal resources (TemporalServer, TemporalNamespace, SearchAttribute, TemporalSchedule) mapping to Temporal runtime components" caption="How chant Temporal resources map to Temporal runtime" />
