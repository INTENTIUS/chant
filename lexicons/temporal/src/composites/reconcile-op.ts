/**
 * Re-export shim (#2120). ReconcileOp moved to `packages/core/src/op/composites/`
...
export { ReconcileOp, type ReconcileOpConfig, type ReconcileOpResources } from "@intentius/chant/op";
