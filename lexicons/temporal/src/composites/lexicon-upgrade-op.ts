/**
 * Re-export shim (#2120). LexiconUpgradeOp moved to `packages/core/src/op/composites/`
...
export { LexiconUpgradeOp, IN_SCOPE_LEXICONS, type LexiconUpgradeOpConfig, type LexiconUpgradeOpResources } from "@intentius/chant/op";
