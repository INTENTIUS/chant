/**
 * Re-export shim (#2120). PipelineAuditOp moved to `packages/core/src/op/composites/`
...
export { PipelineAuditOp, type PipelineAuditOpConfig, type PipelineAuditOpResources } from "@intentius/chant/op";
