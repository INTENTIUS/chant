...
/**
 * Provide Flyway resource completions based on context.
 */
export function flywayCompletions(ctx: CompletionContext): CompletionItem[] {
  return lexiconCompletions(ctx, getIndex(), "Flyway config type");
}
