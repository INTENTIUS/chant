...
/**
 * Provide Azure completions based on context.
 */
export function azureCompletions(ctx: CompletionContext): CompletionItem[] {
  return lexiconCompletions(ctx, getIndex(), "Azure ARM resource");
}
