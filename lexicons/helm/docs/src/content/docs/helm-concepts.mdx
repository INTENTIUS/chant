...
{/* GENERATED-BY-CHANT-DOCS by `npm run docs -w @intentius/chant-lexicon-helm` — DO NOT EDIT.
    Edit lexicons/helm/docs/pages/helm-concepts.mdx instead; changes here are overwritten. */}
...
Property access is all the proxy supports; the paths are not calls. For a
