---
title: "All Rules"
description: "Every lint rule and post-synth check provided by the Helm lexicon"
---
...
The Helm lexicon provides **27** rules: 4 lint rules and 23 post-synth checks.
...
| `WHM503` | Pinned render artifact must not carry populated Secret data/stringData |
| `WHM504` | Detect supplied values that never survive coalescing (shadowed, disabled subchart, unknown subchart) |
