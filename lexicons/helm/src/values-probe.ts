 ...
 *   subchart path. WHM503 turns these into lint diagnostics.
 */
 ...
 * touched. Every run is recorded for WHM503 (`getValuesProbeRecords`).
 */
...
/** What one probe run recorded about itself — the WHM503 lint surface. */
