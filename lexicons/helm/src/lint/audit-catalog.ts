...
export const helmAuditCatalog: Record<string, RuleMeta> = {
  ...
  WHM503: auditRule("WHM503", "merge-worthy", "guidance", "Dead value assignment", "Remove supplied values that never survive coalescing (shadowed, disabled subchart, or unknown subchart).", { category: "correctness" }),
};
