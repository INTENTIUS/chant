...
description: "Typed K8s::* classes generated from third-party CRDs — Gateway API, cert-manager, CloudNativePG, the CockroachDB operator, KubeRay, Argo CD, and Flux — plus how the CRD source list works and how to add your own."
---
