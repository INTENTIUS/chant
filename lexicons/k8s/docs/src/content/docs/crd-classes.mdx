...
description: "Typed K8s::* classes generated from third-party CRDs — Gateway API, cert-manager, the CockroachDB operator, KubeRay, Argo CD, and Flux — plus how the CRD source list works and how to add your own."
---
...
The Flux rows show the override at work: six distinct groups all map to one `Flux` namespace (see [Flux](#flux)), rather than each group's first segment.
