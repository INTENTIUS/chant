 ...
 * against. The `live-plan` half was gated shut on choudoufu#894 until
 * v0.14.0, which made the `-json` document reachable on a configuration that
 * names its own estate and kept stdout to it (choudoufu PR 915); chant #2168
 * dropped the gate and recorded the first run.
 */
