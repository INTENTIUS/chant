...
33 actions are mapped out of the box (lifted from the upstream skill's [`references/marketplace-actions.md`](https://gitlab.com/gitlab-org/ci-cd/github-actions-to-gitlab-ci/-/blob/master/github-actions-to-gitlab-ci/references/marketplace-actions.md)):
