...
- The marketplace-action mapping table — ported as a typed `ActionMapping[]` registry in [`src/migrate/from-github/actions/`](https://github.com/INTENTIUS/chant/tree/main/lexicons/gitlab/src/migrate/from-github/actions).
