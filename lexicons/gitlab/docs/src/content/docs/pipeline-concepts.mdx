...
| `Inherit` | Job | Controls which defaults a job inherits |
| `Service` | Job | Sidecar service container |
| `WorkflowRule` | Workflow | Workflow-level conditional execution rule |
