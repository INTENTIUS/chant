 ...
 *
 * Usage: bun run scripts/full-roundtrip-helper.ts [--skip-serialize] <pipeline-file>
 */
...
if (import.meta.main) {
  ...
  if (!file) {
    console.error("Usage: bun run full-roundtrip-helper.ts [--skip-serialize] <pipeline-file>");
    process.exit(1);
  }
