 ...
 * ever called. This module does not re-derive names; it only carries
 * already-resolved ones across.
 *
...
import { discover, type DiscoveryOptions, type FoldDecision } from "./index";
 ...
 * {@link encodeEntitySet}. This is the boundary chant#1045 Phase 2 will move
 * into a child process; Phase 1 only proves the data can cross it losslessly
