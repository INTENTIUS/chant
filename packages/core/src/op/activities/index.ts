...
// there by the activity registry per the project's configured lexicons. What is
// here is the product-agnostic base every runtime needs, core's own since #2114:
