...
/**
 * azure lexicon upgrade Op (epic #523 / #527).
 *
 * Runs one-shot on the local executor via `chant run azure-upgrade --local`.
 ...
 *   CHANT_UPGRADE_MODE=report chant run azure-upgrade --local
 *
...
export default LexiconUpgradeOp({ lexicon: "azure", onFinding: mode }).op;
