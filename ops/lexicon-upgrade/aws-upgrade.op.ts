 ...
 *
 * Runs one-shot on the local executor via `chant run aws-upgrade --local`.
 ...
 *   CHANT_UPGRADE_MODE=report chant run aws-upgrade --local
 *
...
export default LexiconUpgradeOp({ lexicon: "aws", onFinding: mode }).op;
