...
/**
 * docker lexicon upgrade Op (epic #523 / #527).
 *
 * Runs one-shot on the local executor via `chant run docker-upgrade --local`.
 ...
 *   CHANT_UPGRADE_MODE=report chant run docker-upgrade --local
 *
...
export default LexiconUpgradeOp({ lexicon: "docker", onFinding: mode }).op;
