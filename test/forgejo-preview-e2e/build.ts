/**
 * Build the preview-E2E fixture workflow (./src) and write the generated
 * `.forgejo/workflows/preview.yml` into the output directory passed as
 * argv[2].
 *
 * Kept out of ./src so discovery doesn't import this driver. Run by
 * test/forgejo-preview-e2e.sh before handing the workflow to a runner.
 */
...
const dest = join(dir, "preview.yml");
